<?php
/**
 * Creates a Products 6-1 Widget which can be placed in sidebar
 *
 * @class       Electro_Products_6_1_Widget
 * @version     1.0.0
 * @package     Widgets
 * @category    Class
 * @author      Transvelo
...
if( class_exists( 'WP_Widget' ) ) :
	/**
	 * Electro Products 6-1 widget class
	 *
	 * @since 1.0.0
	 */
	class Electro_Products_6_1_Widget extends WP_Widget {

		public function __construct() {
			$widget_ops = array( 'description' => esc_html__( 'Add products 6-1 block widgets to your sidebar.', 'electro' ) );
			parent::__construct( 'electro_products_6_1_widget', esc_html__( 'Electro Product 6-1 Block', 'electro' ), $widget_ops );
		}
		...
		public function widget($args, $instance) {
			...
			if( function_exists( 'electro_products_6_1_block' ) ) {
				electro_products_6_1_block( $atts );
			}
